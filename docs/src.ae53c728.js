parcelRequire = (function(e, r, t, n) {
...
})(
  {
                      ...
                      },
                      {
                        ...
                        value: function() {
                          ...
                          for (var s = {}, c = 0, l = n.length; c < l; c += 1)
                            for (
                              var h = n[c], u = 0, f = this.options.keys.length;
                              u < f;
                              u += 1
                            ) {
                          ...
                          if (null != i) {
                            ...
                            if ('string' == typeof i) {
                              ...
                              if (
                                ...
                                for (
                                  var k = i.split(this.options.tokenSeparator),
                                    x = [],
                                    M = 0;
                                  M < h.length;
                                  M += 1
                                ...
                                m = x[0];
                                for (var O = x.length, j = 1; j < O; j += 1)
                                  m += x[j];
                        ...
                        value: function(e) {
                          ...
                          for (var i = 0, a = e.length; i < a; i += 1) {
                            ...
                            if (
                              ...
                              for (
                                var c = { item: s.item }, l = 0, h = r.length;
                                l < h;
                                l += 1
                              )
                                r[l](s, c);
            ...
            function(e, t) {
              ...
              e.exports = function(e, t) {
                var r =
                  ...
                  s = [];
                if (a)
                  for (var c = 0, l = i.length; c < l; c += 1) {
                    var h = i[c];
                    s.push([e.indexOf(h), h.length - 1]);
                  }
            ...
            function(e, t, n) {
              ...
              e.exports = function(e, t, n, i) {
                ...
                if (-1 !== S) {
                  ...
                  if (
                    ((m = Math.min(M, m)), -1 !== (S = e.lastIndexOf(t, g + b)))
                  ) {
                    var _ = r(t, {
                      errors: 0,
                      currentLocation: S,
    ...
    uMyR: [
      ...
      { './cjs/react.production.min.js': 'GFLd' }
    ],
    DWQ8: [
      function(require, module, exports) {
        'use strict';
    ...
    zLUr: [
      function(require, module, exports) {
        ...
        var t = require('is-plain-object');
        function o(r, t, o, i) {
          if (!u(r)) return r;
          var c = i || {},
            a = Array.isArray(t);
          if (!a && 'string' != typeof t) return r;
          var p = c.merge;
          p && 'function' != typeof p && (p = Object.assign);
          var l = (a ? t : e(t, c)).filter(f),
            s = l.length,
            y = r;
          if (!i && 1 === l.length) return n(r, l[0], o, p), r;
          for (var m = 0; m < s; m++) {
            var v = l[m];
            if ((u(r[v]) || (r[v] = {}), m === s - 1)) {
              n(r, v, o, p);
        ...
        function n(r, o, n, e) {
          e && t(r[o]) && t(n) ? (r[o] = e({}, r[o], n)) : (r[o] = n);
        }
        function e(r, t) {
          var n = i(r, t);
          if (o.memo[n]) return o.memo[n];
          var e = t && t.separator ? t.separator : '.',
            f = [],
            u = [];
          f = t && 'function' == typeof t.split ? t.split(r) : r.split(e);
          for (var c = 0; c < f.length; c++) {
            for (var a = f[c]; a && '\\' === a.slice(-1) && f[c + 1]; )
              a = a.slice(0, -1) + e + f[++c];
            u.push(a);
          }
          return (o.memo[n] = u), u;
        ...
        (o.memo = {}), (module.exports = o);
      },
      { 'is-plain-object': 'GWG2' }
    ],
    MW4J: [
      function(require, module, exports) {
        'use strict';
        function e(e, t, s) {
          const c = e.split('').length,
            n = Array.isArray(t[0]) ? t : [t],
            r = [],
            h = [];
          function i(t, c, n) {
            const i = e.slice(t, c);
            if (i.length && (h.push({ chars: i, index: n }), s)) {
              const e = s({ chars: i, matches: !1 });
              r.push(e);
            }
          }
          for (let o = 0, a = n.length; o < a; o++) {
            ...
            const f = e.slice(l, u);
            if (s) {
              const e = s({ chars: f, matches: !0 });
              r.push(e);
            } else r.push(f);
            if (h < c) {
              i(h + 1, o < a - 1 ? n[o + 1][0] : c, r.length);
            }
            if (h >= c) break;
          }
          return { unmatched: h, matched: r };
        }
        Object.defineProperty(exports, '__esModule', { value: !0 }),
          (exports.default = e);
      },
      ...
      function(require, module, exports) {
        ...
        function r(t) {
          ...
          return (
            t.forEach((t, a) => {
              r.push(
                Object.assign({}, t, { formatted: Object.assign({}, t.item) })
              ),
                t.matches.forEach(({ indices: t, key: i, value: u }) => {
                  const { matched: o } = s.default(
                    u,
                    t,
                    ({ chars: t, matches: e }) => ({
                      text: t,
        ...
        exports.formatResults = r;
      },
      { 'set-value': 'zLUr', strind: 'MW4J' }
    ],
    gZHD: [
      function(require, module, exports) {
        'use strict';
        ...
        Object.defineProperty(exports, '__esModule', { value: !0 });
        const s = t(require('fuse.js')),
          r = e(require('react')),
          i = require('./formatResults');
        class n extends r.Component {
          constructor() {
            super(...arguments),
              (this.state = { results: [], cache: {}, info: { timing: 0 } });
          }
          componentDidMount() {
            const { data: t, options: e } = this.props;
            (this.fuse = new s.default(
              t,
              Object.assign({}, e, { shouldSort: !0, includeMatches: !0 })
            )),
              this.search();
          }
          componentDidUpdate(t) {
            t.query !== this.props.query && this.search(),
          ...
          render() {
            const { children: t } = this.props,
              { results: e, info: s } = this.state;
            return t
              ? t({
                  results: e,
                  formattedResults: i.formatResults(e),
                  timing: s.timing
                })
              : null;
          }
          search() {
            const { query: t } = this.props,
              { cache: e } = this.state;
            if (Object(e).hasOwnProperty(t))
              return this.setState({ results: e[t], info: { timing: 0 } });
            const s = window.performance.now(),
              r = this.fuse.search(t),
              i = window.performance.now();
            this.setState({
              results: r,
              cache: Object.assign({}, e, { [t]: r }),
              info: { timing: parseFloat((i - s).toFixed(3)) }
            });
          }
        }
        exports.default = n;
      },
      { 'fuse.js': '6/Jk', react: 'uMyR', './formatResults': 'Dy1J' }
    ],
    aypx: [
      function(require, module, exports) {
        'use strict';
        ...
        Object.defineProperty(exports, '__esModule', { value: !0 });
        const t = e(require('react'));
        function r(e) {
          return Array.isArray(e.text)
            ? t.createElement(
                t.Fragment,
                null,
                e.text.map(({ text: e, isHighlighted: r }, n) => {
                  const a = `${e}${n}`;
                  return r
                    ? t.createElement('mark', { key: a }, e)
                    : t.createElement(t.Fragment, { key: a }, e);
                })
              )
            : t.createElement(t.Fragment, null, e.text);
        }
        exports.Highlighter = r;
      },
      { react: 'uMyR' }
    ],
    '+vdi': [
      function(require, module, exports) {
        ...
        Object.defineProperty(exports, '__esModule', { value: !0 });
        const t = e(require('./FuzzyHighlighter'));
        var r = require('./Highlighter');
        (exports.Highlighter = r.Highlighter), (exports.default = t.default);
      },
      { './FuzzyHighlighter': 'gZHD', './Highlighter': 'aypx' }
    ],
    SRY9: [
      function(require, module, exports) {
        module.exports = [
    ...
    '/NHn': [
      function(require, module, exports) {
        ...
        var n = e(require('react')),
          a = e(require('react-fuzzy-highlighter')),
          o = r(require('./data/default.json')),
          i = (function(e) {
            function r() {
              var t = (null !== e && e.apply(this, arguments)) || this;
              return (
                (t.state = { query: 'John', data: o.default }),
                (t.handleChange = function(e) {
                  t.setState({ query: e.target.value });
                }),
                t
              );
            }
              ...
              (r.prototype.render = function() {
                return n.createElement(
                  ...
                  n.createElement(
                    ...
                    function(t) {
                      var e = t.formattedResults;
                      return n.createElement(
                        'ul',
                        null,
                        e.map(function(t, e) {
                          return void 0 === t.formatted.title
                            ? null
                            : n.createElement(
                                'li',
                                {
                                ...
                                n.createElement(
                                  'div',
                                  null,
                                  n.createElement(a.Highlighter, {
                                    text: t.formatted.title
                                  })
                                ),
                                n.createElement(
                                  'div',
                                  null,
                                  n.createElement(a.Highlighter, {
                                    text: t.formatted.author.firstName
                                  }),
                                  ' ',
                                  n.createElement(a.Highlighter, {
                                    text: t.formatted.author.lastName
                                  })
                                )
                              );
                        })
      ...
      {
        react: '1n8/',
        'react-fuzzy-highlighter': '+vdi',
        './data/default.json': 'SRY9'
      }
    ],
    zo2T: [
      function(require, module, exports) {
        ...
        var t = e(require('react')),
          ...
          i = r(require('./App'));
        u.render(
          t.createElement(i.default, null),
          document.getElementById('root')
        );
      },
      { react: '1n8/', 'react-dom': 'NKHc', './App': '/NHn' }
    ]
  },
  {},
  ['zo2T'],
